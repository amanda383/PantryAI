...
export default function ForgotPassword() {
  let [fontsLoaded, fontError] = useFonts({
    Nunito_600SemiBold, Nunito_700Bold, Nunito_400Regular
  });
  ...
  return (
    <LinearGradient colors={["#E5ECF9", "F6F7F9", "#E8EEF9"]} style={styles.container}>

      <Text style={[styles.headerText, { fontFamily: "Nunito_600SemiBold" }]}>
        Reset Email Password
      </Text>
      {/* text input to get email */}
      <TextInput
        style={[styles.input, { fontFamily: "Nunito_400Regular" }]}
        placeholder="Username@gmail.com"
        keyboardType="email-address"
      />
      {/* need to add functionality to forgot password to connect it to user*/}
